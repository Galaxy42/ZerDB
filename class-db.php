...
/** todas las tablas... */
	...
	*
	**/
	public $err_track = true;
	/**
	*
	* Charset por default 'utf-8'
	*
	* @access public
	* @since 0.1
	*
	...
	**/
	function _insertar_y_reemplazar($tabla = null, $datos = false, $add = '', $accion = null) {
		...
		if( ! in_array($tabla, $this->tablas) ) {
			$this->ult_err = "La tabla elegida no existe";
			return false;
		}
	...
	**/
	function actualizar($tabla = null, $datos = false, $donde = false, $add = '' ) {
		...
		if( !in_array($tabla, $this->tablas) ) {
			$this->ult_err = "La tabla seleccionada no existe";
			return false;
		}
...
class extraer {
	...
	public function __construct($tabla = null, $dato = null, $donde = false, $extra = false) {
		...
		if( ! in_array($tabla, $zerdb->tablas) ) {
			$this->obt_error = "La tabla seleccionada no existe";
			return false;
		}
		if($dato = "todo")
			$dato = "*";
